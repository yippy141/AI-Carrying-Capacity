...
- [ ] Review and merge the draft issue #37 source-promotion PR before starting fusion domain review or S5 adjudication. Preserve native-language/specialist quotation and translated-wording blocks; refresh the STEP living page successfully before public/load-bearing target use (promotion-time TLS certificate failure).
