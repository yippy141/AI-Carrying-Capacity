...
- [ ] Review the corrected issue #35 promotion/scope exceptions only before canonical source-register promotion; obtain native-language, legal/regulatory, or fusion-materials specialist review only where the exception queue remains load-bearing.
