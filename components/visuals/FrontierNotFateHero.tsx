...
export function FrontierNotFateHero({experimental,significant,preview}:{experimental:string;significant:string;preview:boolean}) {
  return <section className="reader-hero">
    <p className="edition-note">Supporting study · {preview ? "review preview" : "author-reviewed edition"} · edition updated 6 September 2026</p>
    ...
    <nav className="reading-depths" aria-label="Choose your reading depth"><a href="#adoption">Follow the visual study</a><a href="#mechanism">Try the workflow experiment</a><Link href="/work/paper">Read the paper</Link></nav>
  </section>;
}
