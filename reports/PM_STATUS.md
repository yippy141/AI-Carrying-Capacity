...
The repo has a strong V0 scaffold, staged research, and interactive product shell. It should not be described as an evidence product until canonical sources, indicators, claims, and launch copy are reviewed.

## Active Branches

| Branch | Objective | Status |
| --- | --- | --- |
| `agent/source-promotion-30-review-20260627` | Promote first reviewed canonical source rows | Planned / next |
...
| Issue | Objective | Status |
| --- | --- | --- |
| #11 | Final adversarial launch review | Blocked by #6, #7, and #10 |
...
| Official claims need stronger schema/UI separation | #3, #9 | Fixed in schema and visual guardrails; still needs reviewed source usage |
| Scenario UI may read as forecast | #8 | Fixed on main |
| Staged visuals may look like evidence | #9 | Fixed on main |
...
- Public visuals using staged data: yes, now guarded with staged-evidence banners on main.
